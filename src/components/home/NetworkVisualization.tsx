  ...
  return (
    <div className="relative w-full max-w-[580px] aspect-square flex items-center justify-center mx-auto lg:ml-auto">
      ...
      >
        ...
        {/* Connecting Radial Lines to Status Badges & Outer Nodes */}
        <line x1="250" y1="250" x2="250" y2="25" stroke="rgba(139, 92, 246, 0.4)" strokeWidth="1.5" strokeDasharray="3 3" />
        <line x1="250" y1="250" x2="60" y2="250" stroke="rgba(139, 92, 246, 0.4)" strokeWidth="1.5" strokeDasharray="3 3" />
        <line x1="250" y1="250" x2="440" y2="250" stroke="rgba(59, 130, 246, 0.4)" strokeWidth="1.5" strokeDasharray="3 3" />
        <line x1="250" y1="250" x2="250" y2="475" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" strokeDasharray="3 3" />
      ...
      {/* Four Anchored Connected Status Badges */}

      {/* 1. TOP BADGE — REPORTED */}
      <div className="absolute -top-1 left-1/2 -translate-x-1/2 z-20">
        <div className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-[#0B0F1B]/90 border border-violet-500/40 text-violet-300 text-xs md:text-sm font-semibold shadow-[0_0_18px_rgba(124,58,237,0.3)] backdrop-blur-md">
      ...
      <div className="absolute top-1/2 -right-3 md:-right-6 -translate-y-1/2 z-20">
        <div className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-[#0B0F1B]/90 border border-blue-500/40 text-blue-300 text-xs md:text-sm font-semibold shadow-[0_0_18px_rgba(59,130,246,0.3)] backdrop-blur-md">
      ...
      <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 z-20">
        <div className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-[#0B0F1B]/90 border border-cyan-500/40 text-cyan-300 text-xs md:text-sm font-semibold shadow-[0_0_18px_rgba(6,182,212,0.3)] backdrop-blur-md">
